        ...
        <div className='mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 flex flex-col'>
            <div className='w-full pt-4 mt-5 mr-2 pb-7 rounded drop-shadow-md'>
                <div>
                    ...
                    }} className={'btn-main-bg p-2 ml-2 mt-2 rounded'}>İstifadəçilər
                    </button>
                    <button onClick={() => {
                        setShowTab(<AdminEntrepreneurs/>)
                        setTitle("Lahiyələr")
                    }} className={'btn-main-bg p-2 ml-2 mt-2 rounded'}>Lahiyələr
                    </button>
                    <button onClick={() => {
                        setShowTab(<AdminInvestments/>)
                        setTitle("Pul göndərəcəklər")
                    }} className={'btn-main-bg p-2 ml-2 mt-2 rounded'}>Pul göndərəcəklər
                    </button>
                    <button onClick={() => {
                        setShowTab(<AdminInvestorPayments/>)
                        setTitle("Ödəniş Hesabatı")
                    }} className={'btn-main-bg p-2 ml-2 mt-2 rounded'}>Ödəniş Hesabatı
                    </button>
                    <button onClick={() => {
                        setShowTab(<AdminDebtFund/>)
                        setTitle("Fond Hesabatı")
                    }} className={'btn-main-bg p-2 ml-2 mt-2 rounded'}>Fond Hesabatı
                    </button>
                </div>
                {
