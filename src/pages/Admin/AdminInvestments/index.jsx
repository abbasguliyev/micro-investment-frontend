                                            ...
                                            <td className="border border-slate-700 cursor-pointer text-sky-700 px-6 py-1 text-xs w-40">
                                                {
                                                    investment.is_amount_sended_submitted ? (
                                                        <div onClick={() => changeAmountSumbitStatus(investment)} className="ml-auto pointer-events-auto  mx-20 h-6 w-10 rounded-full p-1 ring-1 ring-inset transition duration-200 ease-in-out bg-indigo-600 ring-black/20">
