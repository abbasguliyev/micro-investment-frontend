...
function EntrepreneurUpdate() {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            count: entrepreneur ? entrepreneur.count || "" : "",
            purchase_price: entrepreneur ? entrepreneur.purchase_price || "" : "",
            sale_price: entrepreneur ? entrepreneur.sale_price || "" : "",
            total_investment: entrepreneur ? entrepreneur.total_investment || "" : "",
            gross_income: entrepreneur ? entrepreneur.gross_income || "" : "",
            platform_cost_percentage: entrepreneur ? entrepreneur.platform_cost_percentage || "" : "",
            platform_cost: entrepreneur ? entrepreneur.platform_cost || "" : "",
            final_profit: entrepreneur ? entrepreneur.final_profit || "" : "",
            investor_share_percentage: entrepreneur ? entrepreneur.investor_share_percentage || "" : "",
            investor_share: entrepreneur ? entrepreneur.investor_share || "" : "",
            entrepreneur_share_percentage: entrepreneur ? entrepreneur.entrepreneur_share_percentage || "" : "",
            entrepreneur_share: entrepreneur ? entrepreneur.entrepreneur_share || "" : "",
            debt_to_the_fund_percentage: entrepreneur ? entrepreneur.debt_to_the_fund_percentage || "" : "",
            debt_to_the_fund: entrepreneur ? entrepreneur.debt_to_the_fund || "" : "",
            charity_to_the_fund_percentage: entrepreneur ? entrepreneur.charity_to_the_fund_percentage || "" : "",
            charity_to_the_fund: entrepreneur ? entrepreneur.charity_to_the_fund || "" : "",
            profit_ratio: entrepreneur ? entrepreneur.profit_ratio || "" : "",
        },
        onSubmit: (values) => {
            values.id = id
